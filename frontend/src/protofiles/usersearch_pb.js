...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.UserSearchRequest.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.proto.UserSearchRequest}
 */
proto.proto.UserSearchRequest.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserSearchRequest.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
