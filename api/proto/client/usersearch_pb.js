...
proto.proto.InstaPost = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.proto.InstaPost.repeatedFields_, null);
};
...
proto.proto.InstaPostsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.proto.InstaPostsResponse.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.proto.UserNameRequest.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.proto.UserNameRequest}
 */
proto.proto.UserNameRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserNameRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserName();
  if (f.length > 0) {
    writer.writeString(
...
proto.proto.InstaPost.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    taggedUsersList: jspb.Message.toObjectList(msg.getTaggedUsersList(),
    proto.proto.User.toObject, includeInstance),
...
proto.proto.InstaPost.prototype.getTaggedUsersList = function() {
  return /** @type{!Array<!proto.proto.User>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.User, 5));
};
 ...
 * @return {!proto.proto.User}
 */
proto.proto.InstaPost.prototype.addTaggedUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.proto.User, opt_index);
};
 ...
 * @return {!Object}
 */
proto.proto.InstaPostsResponse.prototype.toObject = function(opt_includeInstance) {
...
proto.proto.InstaPostsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    instaPostsList: jspb.Message.toObjectList(msg.getInstaPostsList(),
    proto.proto.InstaPost.toObject, includeInstance)
  };
...
proto.proto.InstaPostsResponse.deserializeBinary = function(bytes) {
  ...
  return proto.proto.InstaPostsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.proto.InstaPostsResponse}
 */
proto.proto.InstaPostsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      reader.readMessage(value,proto.proto.InstaPost.deserializeBinaryFromReader);
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.InstaPostsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
...
proto.proto.InstaPostsResponse.prototype.getInstaPostsList = function() {
  return /** @type{!Array<!proto.proto.InstaPost>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.InstaPost, 2));
};
 ...
 * @return {!proto.proto.InstaPost}
 */
proto.proto.InstaPostsResponse.prototype.addInstaPosts = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.proto.InstaPost, opt_index);
};
